...
export default function App() {
  return (
    ...
    >
      <div
        className="flex row-span-0 h-9 text-gray-600 font-bold rounded-xl justify-end "
        style={{ background: "#ECF4E9", fontSize: "22px" }}
      >
        <div className="mr-auto hidden sm:block">Public Markets</div>

        <div className="mr-auto  sm:hidden text-xs flex items-center">
          Public Market
        </div>
      ...
      <div className="bg-white pb-4 px-6">
        {/** header Company Profile || insights || Files  */}
        <div
          className="flex flex-col  w-full    rounded-2xl"
          style={{ backgroundColor: "#FFFFFF" }}
        >
          <div className="h-9.5 my-4   " style={{ backgroundColor: "white" }}>
            <Bar />
          </div>
        </div>

        {/** Content ,Company Profile || insights || Files */}
        ...
        {/**Sentiment Score And Deal Score */}
        <div className="flex">
          <div className="w-45 h-12 bg-blue-500 flex items-center justify-around ">
            Sentiment Score
          </div>
          <div>Deal Score</div>
        </div>
